     ...
     function writePassword() {
       ...
       var password = generatePassword(lowerChar, upperChar, specialChar, numericChar, Chars);
     ...
     function generatePassword(needsLower, needsUpper, needsSpecial, needsNumeric, chars) {
         ...
         console.log(charset);
         retVal = "";
         for (var i = 0, n = charset.length; i < chars; ++i) {
